...
namespace XAMLScreens.CommonControls
{
    public class CustomWindow : Window
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            var btnDragMove = this.GetTemplateChild("PART_TITLEBAR") as Border;

            btnMinimize.Click += btnMinimize_Click;
            btnMaximize.Click += btnMaximize_Click;
            btnClose.Click += btnClose_Click;
            btnDragMove.MouseDown += BtnDragMove_MouseDown;
            this.SourceInitialized += CustomWindow_SourceInitialized;
        }

        private void BtnDragMove_MouseDown(object sender, MouseButtonEventArgs e)
        {
